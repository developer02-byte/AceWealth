      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8 mb-16">
          ...
          <div className="space-y-8 lg:col-span-4 lg:pr-8">
            ...
            <p className="text-slate-400 text-sm leading-relaxed max-w-md">
              Empowering your financial journey with strategic insights and disciplined wealth solutions. Let us guide you towards your financial aspirations.
            </p>
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="space-y-6 text-sm text-slate-400">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:invest@acewealth.co.in" className="hover:text-[#FBAB1C] transition-colors">invest@acewealth.co.in</a>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-6 text-xs text-slate-500">
            ...
            <Link href="/login" className="hover:text-white transition-colors">Manage Your Site</Link>
          </div>
        </div>
      </div>
    </footer>
