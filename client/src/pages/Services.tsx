...
const products: Product[] = [
  {
    ...
    highlights: [
      ...
      "Professional Support — expert fund managers handle investments at reasonable cost",
        ...
        <div className="container mx-auto px-4 md:px-6">
          <motion.div initial="hidden" animate="visible" variants={stagger} className="max-w-3xl mx-auto text-center">
            ...
            <motion.p variants={fadeInUp} className="text-lg md:text-xl text-slate-300 mb-8 max-w-2xl mx-auto leading-relaxed">
              Comprehensive wealth solutions across mutual funds, PMS, AIFs, GIFT City, insurance, and more — tailored to every investor's goals.
            </motion.p>
          </motion.div>
        </div>
      </section>
