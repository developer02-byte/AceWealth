      ...
      <div className="container max-w-4xl mx-auto px-4 md:px-6">
        ...
        <div className="glass-card p-8 md:p-12 rounded-3xl space-y-8 text-muted-foreground leading-relaxed relative z-10">
          ...
          <section>
            ...
            <p>
              If you have any questions about this privacy policy or our privacy practices, please contact us at: <a href="mailto:info@acewealth.co.in" className="text-primary hover:underline">info@acewealth.co.in</a>.
            </p>
          </section>
        </div>
      </div>
